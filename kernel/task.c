...
void Kernel_task_start(void) // no need to backup(save) current task
{
...
void Kernel_task_scheduler(void)
{
    ...
    //sNext_tcb = Schduler_priority_algorithm();
...
static KernelTcb_t* Schduler_priority_algorithm(void)
{
    uint32_t max_priority_index = sCurrent_tcb_index; // 0 is max priority
